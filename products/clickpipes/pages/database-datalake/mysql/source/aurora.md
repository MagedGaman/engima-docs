...
<img src="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.png" alt="Enabling automated backups in Aurora"/>
...
<img src="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/aurora_config.png" alt="Where to find parameter group in Aurora"/>
...
<img src="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_metadata.png" alt="Binlog row metadata"/>

3. `binlog_row_image` to `FULL`.

<img src="/images/integrations/data-ingestion/clickpipes/mysql/parameter_group/binlog_row_image.png" alt="Binlog row image"/>
...
<img src="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/security-group-in-rds-mysql.png" alt="Where to find security group in Aurora MySQL?"/>
