...
{/* <!--AUTOGENERATED_START--> */}
## financialInternalRateOfReturn <Badge intent="info" className="version-badge">v25.7+</Badge> [#financialInternalRateOfReturn]
...
## financialInternalRateOfReturnExtended <Badge intent="info" className="version-badge">v25.7+</Badge> [#financialInternalRateOfReturnExtended]
...
## financialNetPresentValue <Badge intent="info" className="version-badge">v25.7+</Badge> [#financialNetPresentValue]
...
## financialNetPresentValueExtended <Badge intent="info" className="version-badge">v25.7+</Badge> [#financialNetPresentValueExtended]
