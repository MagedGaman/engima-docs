...
{/* <!--AUTOGENERATED_START--> */}
## addressToLine <Badge intent="info" className="version-badge">v20.1+</Badge> [#addressToLine]
...
## addressToLineWithInlines <Badge intent="info" className="version-badge">v22.2+</Badge> [#addressToLineWithInlines]
...
## addressToSymbol <Badge intent="info" className="version-badge">v20.1+</Badge> [#addressToSymbol]
...
## demangle <Badge intent="info" className="version-badge">v20.1+</Badge> [#demangle]
...
## isMergeTreePartCoveredBy <Badge intent="info" className="version-badge">v25.6+</Badge> [#isMergeTreePartCoveredBy]
...
## logTrace <Badge intent="info" className="version-badge">v20.12+</Badge> [#logTrace]
...
## mergeTreePartInfo <Badge intent="info" className="version-badge">v25.6+</Badge> [#mergeTreePartInfo]
...
## tid <Badge intent="info" className="version-badge">v20.12+</Badge> [#tid]
