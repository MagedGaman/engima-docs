...
{/* <!--AUTOGENERATED_START--> */}
## alphaTokens <Badge intent="info" className="version-badge">v1.1+</Badge> [#alphaTokens]
...
## arrayStringConcat <Badge intent="info" className="version-badge">v1.1+</Badge> [#arrayStringConcat]
...
## extractAllGroupsVertical <Badge intent="info" className="version-badge">v20.5+</Badge> [#extractAllGroupsVertical]
...
## ngrams <Badge intent="info" className="version-badge">v21.11+</Badge> [#ngrams]
...
## splitByChar <Badge intent="info" className="version-badge">v1.1+</Badge> [#splitByChar]
...
## splitByNonAlpha <Badge intent="info" className="version-badge">v21.9+</Badge> [#splitByNonAlpha]
...
## splitByRegexp <Badge intent="info" className="version-badge">v21.6+</Badge> [#splitByRegexp]
...
## splitByString <Badge intent="info" className="version-badge">v1.1+</Badge> [#splitByString]
...
## splitByWhitespace <Badge intent="info" className="version-badge">v21.9+</Badge> [#splitByWhitespace]
...
## tokens <Badge intent="info" className="version-badge">v21.11+</Badge> [#tokens]
