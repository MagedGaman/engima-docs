...
{/* <!--AUTOGENERATED_START--> */}
## format <Badge intent="info" className="version-badge">v20.1+</Badge> [#format]
...
## overlay <Badge intent="info" className="version-badge">v24.9+</Badge> [#overlay]
...
## overlayUTF8 <Badge intent="info" className="version-badge">v24.9+</Badge> [#overlayUTF8]
...
## printf <Badge intent="info" className="version-badge">v24.8+</Badge> [#printf]
...
## regexpQuoteMeta <Badge intent="info" className="version-badge">v20.1+</Badge> [#regexpQuoteMeta]
...
## replaceAll <Badge intent="info" className="version-badge">v1.1+</Badge> [#replaceAll]
...
## replaceOne <Badge intent="info" className="version-badge">v1.1+</Badge> [#replaceOne]
...
## replaceRegexpAll <Badge intent="info" className="version-badge">v1.1+</Badge> [#replaceRegexpAll]
...
## replaceRegexpOne <Badge intent="info" className="version-badge">v1.1+</Badge> [#replaceRegexpOne]
...
## translate <Badge intent="info" className="version-badge">v22.7+</Badge> [#translate]
...
## translateUTF8 <Badge intent="info" className="version-badge">v22.7+</Badge> [#translateUTF8]
