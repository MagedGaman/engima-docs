...
{/* <!--AUTOGENERATED_START--> */}
## FQDN <Badge intent="info" className="version-badge">v20.1+</Badge> [#FQDN]
...
## MACNumToString <Badge intent="info" className="version-badge">v1.1+</Badge> [#MACNumToString]
...
## MACStringToNum <Badge intent="info" className="version-badge">v1.1+</Badge> [#MACStringToNum]
...
## MACStringToOUI <Badge intent="info" className="version-badge">v1.1+</Badge> [#MACStringToOUI]
...
## __filterContains <Badge intent="info" className="version-badge">v25.10+</Badge> [#__filterContains]
...
True if the key was found in the filter [`Bool`](/sql-reference/data-types/boolean)
...
## __patchPartitionID <Badge intent="info" className="version-badge">v25.5+</Badge> [#__patchPartitionID]
...
## authenticatedUser <Badge intent="info" className="version-badge">v25.11+</Badge> [#authenticatedUser]
...
## bar <Badge intent="info" className="version-badge">v1.1+</Badge> [#bar]
...
## blockNumber <Badge intent="info" className="version-badge">v1.1+</Badge> [#blockNumber]
...
## blockSerializedSize <Badge intent="info" className="version-badge">v20.3+</Badge> [#blockSerializedSize]
...
## blockSize <Badge intent="info" className="version-badge">v1.1+</Badge> [#blockSize]
...
## buildId <Badge intent="info" className="version-badge">v20.5+</Badge> [#buildId]
...
## byteSize <Badge intent="info" className="version-badge">v21.1+</Badge> [#byteSize]
...
## catboostEvaluate <Badge intent="info" className="version-badge">v22.9+</Badge> [#catboostEvaluate]
...
## colorOKLCHToSRGB <Badge intent="info" className="version-badge">v25.7+</Badge> [#colorOKLCHToSRGB]
...
## colorSRGBToOKLCH <Badge intent="info" className="version-badge">v25.7+</Badge> [#colorSRGBToOKLCH]
...
## connectionId <Badge intent="info" className="version-badge">v21.3+</Badge> [#connectionId]
...
## countDigits <Badge intent="info" className="version-badge">v20.8+</Badge> [#countDigits]
...
## currentDatabase <Badge intent="info" className="version-badge">v1.1+</Badge> [#currentDatabase]
...
## currentProfiles <Badge intent="info" className="version-badge">v21.9+</Badge> [#currentProfiles]
...
## currentQueryID <Badge intent="info" className="version-badge">v+</Badge> [#currentQueryID]
...
## currentRoles <Badge intent="info" className="version-badge">v21.9+</Badge> [#currentRoles]
...
## currentSchemas <Badge intent="info" className="version-badge">v23.7+</Badge> [#currentSchemas]
...
## currentUser <Badge intent="info" className="version-badge">v20.1+</Badge> [#currentUser]
...
## defaultProfiles <Badge intent="info" className="version-badge">v21.9+</Badge> [#defaultProfiles]
...
## defaultRoles <Badge intent="info" className="version-badge">v21.9+</Badge> [#defaultRoles]
...
## defaultValueOfArgumentType <Badge intent="info" className="version-badge">v1.1+</Badge> [#defaultValueOfArgumentType]
...
## defaultValueOfTypeName <Badge intent="info" className="version-badge">v1.1+</Badge> [#defaultValueOfTypeName]
...
## displayName <Badge intent="info" className="version-badge">v22.11+</Badge> [#displayName]
...
## dumpColumnStructure <Badge intent="info" className="version-badge">v1.1+</Badge> [#dumpColumnStructure]
...
## enabledProfiles <Badge intent="info" className="version-badge">v21.9+</Badge> [#enabledProfiles]
...
## enabledRoles <Badge intent="info" className="version-badge">v21.9+</Badge> [#enabledRoles]
...
## errorCodeToName <Badge intent="info" className="version-badge">v20.12+</Badge> [#errorCodeToName]
...
## file <Badge intent="info" className="version-badge">v21.3+</Badge> [#file]
...
## filesystemAvailable <Badge intent="info" className="version-badge">v20.1+</Badge> [#filesystemAvailable]
...
## filesystemCapacity <Badge intent="info" className="version-badge">v20.1+</Badge> [#filesystemCapacity]
...
## filesystemUnreserved <Badge intent="info" className="version-badge">v22.12+</Badge> [#filesystemUnreserved]
...
## finalizeAggregation <Badge intent="info" className="version-badge">v1.1+</Badge> [#finalizeAggregation]
...
## flipCoordinates <Badge intent="info" className="version-badge">v25.10+</Badge> [#flipCoordinates]
...
## formatQuery <Badge intent="info" className="version-badge">v+</Badge> [#formatQuery]
...
## formatQueryOrNull <Badge intent="info" className="version-badge">v+</Badge> [#formatQueryOrNull]
...
## formatQuerySingleLine <Badge intent="info" className="version-badge">v+</Badge> [#formatQuerySingleLine]
...
## formatQuerySingleLineOrNull <Badge intent="info" className="version-badge">v+</Badge> [#formatQuerySingleLineOrNull]
...
## formatReadableDecimalSize <Badge intent="info" className="version-badge">v22.11+</Badge> [#formatReadableDecimalSize]
...
## formatReadableQuantity <Badge intent="info" className="version-badge">v20.10+</Badge> [#formatReadableQuantity]
...
## formatReadableSize <Badge intent="info" className="version-badge">v1.1+</Badge> [#formatReadableSize]
...
## formatReadableTimeDelta <Badge intent="info" className="version-badge">v20.12+</Badge> [#formatReadableTimeDelta]
...
## generateRandomStructure <Badge intent="info" className="version-badge">v23.5+</Badge> [#generateRandomStructure]
...
## generateSerialID <Badge intent="info" className="version-badge">v25.1+</Badge> [#generateSerialID]
...
## getClientHTTPHeader <Badge intent="info" className="version-badge">v24.5+</Badge> [#getClientHTTPHeader]
...
## getMacro <Badge intent="info" className="version-badge">v20.1+</Badge> [#getMacro]
...
## getMaxTableNameLengthForDatabase <Badge intent="info" className="version-badge">v+</Badge> [#getMaxTableNameLengthForDatabase]
...
## getMergeTreeSetting <Badge intent="info" className="version-badge">v25.6+</Badge> [#getMergeTreeSetting]
...
## getOSKernelVersion <Badge intent="info" className="version-badge">v21.11+</Badge> [#getOSKernelVersion]
...
## getServerPort <Badge intent="info" className="version-badge">v21.10+</Badge> [#getServerPort]
...
## getServerSetting <Badge intent="info" className="version-badge">v25.6+</Badge> [#getServerSetting]
...
## getSetting <Badge intent="info" className="version-badge">v20.7+</Badge> [#getSetting]
...
## getSettingOrDefault <Badge intent="info" className="version-badge">v24.10+</Badge> [#getSettingOrDefault]
...
## getSizeOfEnumType <Badge intent="info" className="version-badge">v1.1+</Badge> [#getSizeOfEnumType]
...
## getSubcolumn <Badge intent="info" className="version-badge">v+</Badge> [#getSubcolumn]
...
## getTypeSerializationStreams <Badge intent="info" className="version-badge">v22.6+</Badge> [#getTypeSerializationStreams]
...
## globalVariable <Badge intent="info" className="version-badge">v20.5+</Badge> [#globalVariable]
...
## hasColumnInTable <Badge intent="info" className="version-badge">v1.1+</Badge> [#hasColumnInTable]
...
## hasThreadFuzzer <Badge intent="info" className="version-badge">v20.6+</Badge> [#hasThreadFuzzer]
...
## hostName <Badge intent="info" className="version-badge">v20.5+</Badge> [#hostName]
...
## icebergBucket <Badge intent="info" className="version-badge">v25.5+</Badge> [#icebergBucket]
...
## icebergTruncate <Badge intent="info" className="version-badge">v25.3+</Badge> [#icebergTruncate]
...
## identity <Badge intent="info" className="version-badge">v1.1+</Badge> [#identity]
...
## ignore <Badge intent="info" className="version-badge">v1.1+</Badge> [#ignore]
...
## indexHint <Badge intent="info" className="version-badge">v1.1+</Badge> [#indexHint]
...
## initialQueryID <Badge intent="info" className="version-badge">v1.1+</Badge> [#initialQueryID]
...
## initialQueryStartTime <Badge intent="info" className="version-badge">v25.4+</Badge> [#initialQueryStartTime]
...
## initializeAggregation <Badge intent="info" className="version-badge">v20.6+</Badge> [#initializeAggregation]
...
## isConstant <Badge intent="info" className="version-badge">v20.3+</Badge> [#isConstant]
...
## isDecimalOverflow <Badge intent="info" className="version-badge">v20.8+</Badge> [#isDecimalOverflow]
...
## joinGet <Badge intent="info" className="version-badge">v18.16+</Badge> [#joinGet]
...
## joinGetOrNull <Badge intent="info" className="version-badge">v20.4+</Badge> [#joinGetOrNull]
...
## lowCardinalityIndices <Badge intent="info" className="version-badge">v18.12+</Badge> [#lowCardinalityIndices]
...
## lowCardinalityKeys <Badge intent="info" className="version-badge">v18.12+</Badge> [#lowCardinalityKeys]
...
## materialize <Badge intent="info" className="version-badge">v1.1+</Badge> [#materialize]
...
## minSampleSizeContinuous <Badge intent="info" className="version-badge">v23.10+</Badge> [#minSampleSizeContinuous]
...
## minSampleSizeConversion <Badge intent="info" className="version-badge">v22.6+</Badge> [#minSampleSizeConversion]
...
## neighbor <Badge intent="info" className="version-badge">v20.1+</Badge> [#neighbor]
...
## nested <Badge intent="info" className="version-badge">v+</Badge> [#nested]
...
## normalizeQuery <Badge intent="info" className="version-badge">v20.8+</Badge> [#normalizeQuery]
...
## normalizeQueryKeepNames <Badge intent="info" className="version-badge">v21.2+</Badge> [#normalizeQueryKeepNames]
...
## normalizedQueryHash <Badge intent="info" className="version-badge">v20.8+</Badge> [#normalizedQueryHash]
...
## normalizedQueryHashKeepNames <Badge intent="info" className="version-badge">v21.2+</Badge> [#normalizedQueryHashKeepNames]
...
## parseReadableSize <Badge intent="info" className="version-badge">v24.6+</Badge> [#parseReadableSize]
...
## parseReadableSizeOrNull <Badge intent="info" className="version-badge">v24.6+</Badge> [#parseReadableSizeOrNull]
...
## parseReadableSizeOrZero <Badge intent="info" className="version-badge">v24.6+</Badge> [#parseReadableSizeOrZero]
...
## parseTimeDelta <Badge intent="info" className="version-badge">v22.7+</Badge> [#parseTimeDelta]
...
## partitionId <Badge intent="info" className="version-badge">v21.4+</Badge> [#partitionId]
...
## queryID <Badge intent="info" className="version-badge">v21.9+</Badge> [#queryID]
...
## revision <Badge intent="info" className="version-badge">v22.7+</Badge> [#revision]
...
## rowNumberInAllBlocks <Badge intent="info" className="version-badge">v1.1+</Badge> [#rowNumberInAllBlocks]
...
## rowNumberInBlock <Badge intent="info" className="version-badge">v1.1+</Badge> [#rowNumberInBlock]
...
## runningAccumulate <Badge intent="info" className="version-badge">v1.1+</Badge> [#runningAccumulate]
...
## runningConcurrency <Badge intent="info" className="version-badge">v21.3+</Badge> [#runningConcurrency]
...
## runningDifference <Badge intent="info" className="version-badge">v1.1+</Badge> [#runningDifference]
...
## runningDifferenceStartingWithFirstValue <Badge intent="info" className="version-badge">v1.1+</Badge> [#runningDifferenceStartingWithFirstValue]
...
## serverUUID <Badge intent="info" className="version-badge">v20.1+</Badge> [#serverUUID]
...
## shardCount <Badge intent="info" className="version-badge">v21.9+</Badge> [#shardCount]
...
## shardNum <Badge intent="info" className="version-badge">v21.9+</Badge> [#shardNum]
...
## showCertificate <Badge intent="info" className="version-badge">v22.6+</Badge> [#showCertificate]
...
## sleep <Badge intent="info" className="version-badge">v1.1+</Badge> [#sleep]
...
## sleepEachRow <Badge intent="info" className="version-badge">v1.1+</Badge> [#sleepEachRow]
...
## structureToCapnProtoSchema <Badge intent="info" className="version-badge">v+</Badge> [#structureToCapnProtoSchema]
...
## structureToProtobufSchema <Badge intent="info" className="version-badge">v23.8+</Badge> [#structureToProtobufSchema]
...
## tcpPort <Badge intent="info" className="version-badge">v20.12+</Badge> [#tcpPort]
...
## throwIf <Badge intent="info" className="version-badge">v1.1+</Badge> [#throwIf]
...
## toColumnTypeName <Badge intent="info" className="version-badge">v1.1+</Badge> [#toColumnTypeName]
...
## toTypeName <Badge intent="info" className="version-badge">v1.1+</Badge> [#toTypeName]
...
## transactionID <Badge intent="info" className="version-badge">v22.6+</Badge> [#transactionID]
...
## transactionLatestSnapshot <Badge intent="info" className="version-badge">v22.6+</Badge> [#transactionLatestSnapshot]
...
## transactionOldestSnapshot <Badge intent="info" className="version-badge">v22.6+</Badge> [#transactionOldestSnapshot]
...
## transform <Badge intent="info" className="version-badge">v1.1+</Badge> [#transform]
...
## uniqThetaIntersect <Badge intent="info" className="version-badge">v22.9+</Badge> [#uniqThetaIntersect]
...
## uniqThetaNot <Badge intent="info" className="version-badge">v22.9+</Badge> [#uniqThetaNot]
...
## uniqThetaUnion <Badge intent="info" className="version-badge">v22.9+</Badge> [#uniqThetaUnion]
...
## uptime <Badge intent="info" className="version-badge">v1.1+</Badge> [#uptime]
...
## variantElement <Badge intent="info" className="version-badge">v25.2+</Badge> [#variantElement]
...
## variantType <Badge intent="info" className="version-badge">v24.2+</Badge> [#variantType]
...
## version <Badge intent="info" className="version-badge">v1.1+</Badge> [#version]
...
## visibleWidth <Badge intent="info" className="version-badge">v1.1+</Badge> [#visibleWidth]
...
## zookeeperSessionUptime <Badge intent="info" className="version-badge">v21.11+</Badge> [#zookeeperSessionUptime]
