...
{/* <!--AUTOGENERATED_START--> */}
## ceil <Badge intent="info" className="version-badge">v1.1+</Badge> [#ceil]
...
## floor <Badge intent="info" className="version-badge">v1.1+</Badge> [#floor]
...
## round <Badge intent="info" className="version-badge">v1.1+</Badge> [#round]
...
## roundAge <Badge intent="info" className="version-badge">v1.1+</Badge> [#roundAge]
...
## roundBankers <Badge intent="info" className="version-badge">v20.1+</Badge> [#roundBankers]
...
## roundDown <Badge intent="info" className="version-badge">v20.1+</Badge> [#roundDown]
...
## roundDuration <Badge intent="info" className="version-badge">v1.1+</Badge> [#roundDuration]
...
## roundToExp2 <Badge intent="info" className="version-badge">v1.1+</Badge> [#roundToExp2]
...
## trunc <Badge intent="info" className="version-badge">v1.1+</Badge> [#trunc]
