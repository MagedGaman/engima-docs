...
{/* <!--AUTOGENERATED_START--> */}
## aes_decrypt_mysql <Badge intent="info" className="version-badge">v20.12+</Badge> [#aes_decrypt_mysql]
...
## aes_encrypt_mysql <Badge intent="info" className="version-badge">v20.12+</Badge> [#aes_encrypt_mysql]
...
## decrypt <Badge intent="info" className="version-badge">v20.12+</Badge> [#decrypt]
...
## encrypt <Badge intent="info" className="version-badge">v20.12+</Badge> [#encrypt]
...
## tryDecrypt <Badge intent="info" className="version-badge">v22.10+</Badge> [#tryDecrypt]
