...
{/* <!--AUTOGENERATED_START--> */}
## and <Badge intent="info" className="version-badge">v1.1+</Badge> [#and]
...
## not <Badge intent="info" className="version-badge">v1.1+</Badge> [#not]
...
## or <Badge intent="info" className="version-badge">v1.1+</Badge> [#or]
...
## xor <Badge intent="info" className="version-badge">v1.1+</Badge> [#xor]
