...
{/* <!--AUTOGENERATED_START--> */}
## detectCharset <Badge intent="info" className="version-badge">v22.2+</Badge> [#detectCharset]
...
## detectLanguage <Badge intent="info" className="version-badge">v22.2+</Badge> [#detectLanguage]
...
## detectLanguageMixed <Badge intent="info" className="version-badge">v22.2+</Badge> [#detectLanguageMixed]
...
## detectLanguageUnknown <Badge intent="info" className="version-badge">v22.2+</Badge> [#detectLanguageUnknown]
...
## detectProgrammingLanguage <Badge intent="info" className="version-badge">v22.2+</Badge> [#detectProgrammingLanguage]
...
## detectTonality <Badge intent="info" className="version-badge">v22.2+</Badge> [#detectTonality]
...
## lemmatize <Badge intent="info" className="version-badge">v21.9+</Badge> [#lemmatize]
...
## stem <Badge intent="info" className="version-badge">v21.9+</Badge> [#stem]
...
## synonyms <Badge intent="info" className="version-badge">v21.9+</Badge> [#synonyms]
