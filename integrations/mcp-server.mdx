...
| `maxDuration` | number | No | 300000 | Inactivity timeout in milliseconds |
...
| `maxDuration` | number | No | 300000 | Inactivity timeout in ms |
...
3. **Ensure API key format:**
   ...
   - Example: `"url": "https://connect.webrun.ai/mcp/sse?apiKey=enig_xxxxxxxxxxxx"`
...
2. **Check URL format:**
   ```json
   // ❌ Wrong
   "url": "https://connect.webrun.ai/mcp/sse"

   // ✅ Correct
   "url": "https://connect.webrun.ai/mcp/sse?apiKey=enig_xxxxxxxxxxxx"
   ```
...
**Cause:** WebRun sessions expire after 5 minutes of inactivity (300,000 ms default timeout).
...
- Sessions can run indefinitely while active
- Examples:
  - `60000` = 1 minute of inactivity
  - `120000` = 2 minutes of inactivity
  - `300000` = 5 minutes of inactivity (default)
