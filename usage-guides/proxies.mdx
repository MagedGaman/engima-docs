...
|-------|-------------|------|------|
| _Default_ (omitted) | Routed to the best available connection that matches the country | Optimal availability and routing | No manual control over proxy placement |
...
<Tip>
**Recommended:** Leave `level` unset and let WebRun route your session to the most available instance within the defined country. Only set `level` explicitly when you have a specific requirement around IP leakage or cold-start performance.
</Tip>
