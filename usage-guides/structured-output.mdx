...
By default, AI agents return natural language responses. To get structured data (JSON, arrays, specific formats), you need to explicitly request it in your task details.
...
<CardGroup cols={2}>
  ...
  <Card title="Handling Guardrails" icon="shield" href="/usage-guides/handling-guardrails">
    Handle agent requests during data extraction
  </Card>
  ...
  <Card title="Events Reference" icon="bolt" href="/events">
    Real-time task completion events
  </Card>
</CardGroup>
