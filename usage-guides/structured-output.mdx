...
Combine structured output with [webhooks](/usage-guides/webhooks) to automatically deliver validated JSON data to your systems when tasks complete.
...
<Tip>
Use `submittedData: "structured_output"` to receive only the validated JSON data matching your schema. See the [Webhooks guide](/usage-guides/webhooks) for complete documentation.
</Tip>
