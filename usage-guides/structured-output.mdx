...
<Tip>
Use `submittedData: "structured_output"` to receive only the validated data matching your schema (works with both `structured_json` and `structured_csv`). See the [Webhooks guide](/usage-guides/webhooks) for complete documentation.
</Tip>
