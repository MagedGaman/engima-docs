...
description: "Best practices and patterns for reducing costs while using WebRun AI agents"
icon: "piggy-bank"
---

## Overview

WebRun charges based on:
...
const session = await fetch("https://connect.webrun.ai/start/run-task", {
  method: "POST",
  headers: {
