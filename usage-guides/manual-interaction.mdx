...
| `x` | number | Yes | X coordinate (0-1024) |
| `y` | number | Yes | Y coordinate (155-755, with chrome offset) |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `type` | string | Yes | Must be `"DOUBLE_CLICK"` |
| `x` | number | Yes | X coordinate (0-1024) |
| `y` | number | Yes | Y coordinate (155-755) |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `type` | string | Yes | Must be `"TYPE"` |
| `text` | string | Yes | Text to type |
| `humanLike` | boolean | No | Simulate human typing speed (default: false) |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `type` | string | Yes | Must be `"KEY_PRESS"` |
| `key` | string | Yes | Key name (see common values below) |
