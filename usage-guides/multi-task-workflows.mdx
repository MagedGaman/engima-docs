...
| `maxDuration` | number | 300000 | Inactivity timeout in ms (sessions expire after 5 min of inactivity by default) |
...
<Note>
- `maxDuration` is the inactivity timeout; sessions can run indefinitely while active but expire after 5 minutes of inactivity by default
