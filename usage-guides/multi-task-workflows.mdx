...
<Tip>
For workflows that span multiple sessions (e.g., daily recurring tasks that need to stay logged in), use [environments](/environments/overview) to persist browser profile and files between sessions.
</Tip>
...
| `environmentId` | string | null | [Environment](/environments/overview) ID to attach (browser profile + persistent files) |
