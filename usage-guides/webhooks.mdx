---
title: "Webhooks"
description: "Receive automated notifications when tasks complete"
icon: "webhook"
---
...
|-------|-------------|----------|
| `"ai_response"` | The response from the AI (text, structured_json, or structured_csv): only the results/output from the LLM | Production data pipelines |
