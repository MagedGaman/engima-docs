...
```bash
curl -X POST https://api.webrun.ai/environments \
...
```bash
curl https://api.webrun.ai/environments \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl -X DELETE https://api.webrun.ai/environments/<ENV_ID> \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl -X POST https://api.webrun.ai/environments/<ENV_ID>/upload \
  -H "Authorization: Bearer wr_xxx" \
