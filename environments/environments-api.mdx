...
<Tip>
To upload your local Chrome profile instead of a manual archive, use the [sync tool](/environments/sync-profiles) — it packages and uploads your browser data in one command.
</Tip>
...
<Accordion title="Related">
  <CardGroup cols={2}>
    ...
    <Card title="Profile Management API" icon="book" href="/environments/profile-management-api">
      Download, upload, and manage browser profile data
    </Card>
  </CardGroup>
</Accordion>
