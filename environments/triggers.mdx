...
```bash
curl https://api.webrun.ai/cron-jobs \
...
```bash
curl -X POST https://api.webrun.ai/cron-jobs \
  -H "Authorization: Bearer wr_xxx" \
...
```bash
curl https://api.webrun.ai/cron-jobs/<JOB_ID> \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl -X PUT https://api.webrun.ai/cron-jobs/<JOB_ID> \
  -H "Authorization: Bearer wr_xxx" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.webrun.ai/cron-jobs/<JOB_ID> \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl -X POST https://api.webrun.ai/cron-jobs/<JOB_ID>/pause \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl -X POST https://api.webrun.ai/cron-jobs/<JOB_ID>/resume \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl -X POST https://api.webrun.ai/cron-jobs/<JOB_ID>/trigger \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl "https://api.webrun.ai/cron-jobs/<JOB_ID>/runs?page=1&limit=10" \
  -H "Authorization: Bearer wr_xxx"
```
...
```bash
curl https://api.webrun.ai/cron-jobs/<JOB_ID>/runs/<RUN_ID> \
  -H "Authorization: Bearer wr_xxx"
```
