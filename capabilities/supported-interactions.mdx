...
description: "WebRun works on any website—from legacy government portals to modern React apps—without custom configuration"
icon: "hand-pointer"
---

WebRun's AI agent can interact with virtually any element on the web. Whether you're automating legacy government portals or modern single-page applications, WebRun handles it all without custom configuration.
...
**Example:** Instead of writing `document.querySelector('.btn-primary-v2')`, you simply tell WebRun: "Click the submit button."
