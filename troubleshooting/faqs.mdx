...
description: "Answers to common questions about Enigma's browser automation platform"
---
...
Enigma uses **Chromium-based browsers** (similar to Chrome) running in cloud-based instances. Each session gets a dedicated browser instance with:
...
**Note:** You cannot currently specify browser type (Firefox, Safari, etc.) or version. All sessions use the latest Chromium.
...
**Default Limits:**
- **Minimum duration:** 1 second (1,000ms)
- **Maximum duration:** 5 minutes (300,000ms)
- **Default if not specified:** 60 seconds (60,000ms)
...
- **Free Tier:** Max 60 seconds
- **Pro Tier:** Max 5 minutes (300 seconds)
...
Yes, Enigma takes security seriously:
...
- [Privacy Policy](https://enigma.click/privacy)
...
- **Pro Tier:** 5 concurrent sessions
- **Enterprise:** Custom limits (10-100+)
...
**Security Warning:**
Never log or store credentials provided to websites. Use environment variables and secure secret management.
...
Enigma uses its own LLM infrastructure (Claude models from Anthropic) to power the browser agent. You cannot bring your own API keys or use different models.
...
- See current pricing at [enigma.click/pricing](https://enigma.click/pricing)
...
Enigma provides a **REST API** and **WebSocket interface**, making it compatible with any framework or language that can make HTTP requests.
...
**Yes!** Enigma provides a native **Model Context Protocol (MCP) server**.
...
**Yes!** Enigma offers a free tier for testing and small-scale usage.

**Free Tier Includes:**
- **$5 free credits** per month
- **2 concurrent sessions**
- **Max 60 second session duration**
...
**Related:**
- [Pricing Plans](/pricing)
- [Sign Up](https://enigma.click/signup)
...
**How to Set Limits:**
1. Go to [enigma.click/settings/billing](https://enigma.click/settings/billing)
...
CAPTCHAs require human intervention. Enigma provides several approaches:
...
**Device Emulation:**
Currently, Enigma does not support:
...
**Contact:** Email sales@enigma.click for Enterprise pricing
...
- [Contact Sales](mailto:sales@enigma.click)
...
Enigma uses a **standard Chrome User-Agent** that matches the Chromium version.
...
**GitHub:**
- [enigma-examples](https://github.com/enigma-ai/examples) - Sample projects
- [enigma-sdk](https://github.com/enigma-ai/sdk) - Official SDKs
...
- **Discord:** [discord.gg/enigma](https://discord.gg/enigma)
- **Status:** [status.enigma.click](https://status.enigma.click)
