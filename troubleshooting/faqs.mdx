...
Enigma uses its own LLM infrastructure to power the browser agent. You cannot bring your own API keys or use different models.
...
Enigma provides a **REST API**, **WebSocket interface**, **MCP** and OPENAI format, making it compatible with any framework or language that can make HTTP requests.
...
**How to Set Limits:**
1. Go to [app.enigma.click/billing](https://app.enigma.click/billing)
