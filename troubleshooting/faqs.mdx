...
Sessions have a 5-minute maximum. Configure with `maxDuration` (in milliseconds, max: 300000). Default is 5 minutes if not specified.
...
Yes. $5 free credits per month, 2 concurrent sessions, 5-minute session duration. All API features enabled.
