...
<img src="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" alt="MacOS developer verification error dialog"/>
...
1. Navigate to **Privacy & Security**:
    ...
    <img src="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" alt="MacOS Privacy & Security settings default view"/>
...
1. Click **Allow Anyway**.
    ...
    <img src="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" alt="MacOS Privacy & Security settings showing Allow Anyway button"/>
