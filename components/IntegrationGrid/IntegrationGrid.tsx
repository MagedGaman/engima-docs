...
function IntegrationCard({ integration }: { integration: IntegrationData }) {
  ...
  const getLogoSrc = (): string => {
    // If we're in light mode and dark logo is available, use the dark logo (for better contrast)
    // The naming is: integration_logo = light backgrounds, integration_logo_dark = dark backgrounds
