...
description: "Error handling, common issues, and solutions"
---
...
```
**Solution:** Add credits to your account at app.webrun.ai/billing.
...
3. Check system status at status.webrun.ai
...
**Solutions:**
1. Continue polling until completion
...
3. Use a [policy](/concepts/policies) with domain rules to block unnecessary domains
...
3. Use a [policy](/concepts/policies) to block sites requiring auth
