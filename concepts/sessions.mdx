...
```javascript
{
  ...
  "initialTask": {
    ...
    "maxDuration": 300000,                        // Inactivity timeout in ms (optional)
...
- **maxDuration**: Optional inactivity timeout. Sessions expire after 5 minutes of inactivity by default, but can run indefinitely while active.
