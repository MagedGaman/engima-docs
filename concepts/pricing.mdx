---
title: "Pricing & Costs"
description: "Understanding Enigma's pricing model and how to optimize costs"
---
...
|-------|----------------------|------------------------|----------|
| **enigma-browser-1** | $0.60 | $1.80 | Complex tasks, high accuracy |
| **enigma-browser-fast** | $0.40 | $1.20 | Simple tasks, faster execution |

<Note>
Token prices are subject to change. Check the [dashboard](https://app.enigma.click) for current rates.
</Note>
...
### Dashboard
View historical usage and costs at [app.enigma.click](https://app.enigma.click/usage).
...
<Note>
Check your [dashboard](https://app.enigma.click) for current credit balance and any promotional offers.
</Note>
...
- **Billing Dashboard:** [app.enigma.click/billing](https://app.enigma.click/billing)
