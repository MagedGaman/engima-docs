...
Guardrails are Enigma's safety mechanism for human-in-the-loop control. When the AI agent encounters a situation requiring human judgment or sensitive information, it pauses the task and triggers a guardrail.
...
Enigma's guardrails are designed around these principles:
...
Enigma doesn't store credentials. You provide them on-demand when needed.
