...
| `environmentId` | string | null | Environment ID to attach — loads its browser profile and files ([details](/environments/overview)). Top-level parameter, not nested inside the task. |
...
<CardGroup cols={2}>
  ...
  <Card title="Environments" icon="box" href="/environments/overview">
    Reuse browser profile and files across tasks
  </Card>
