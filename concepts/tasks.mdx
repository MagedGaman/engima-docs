...
### Domain Restrictions
Use [automation policies](/concepts/policies) to control which domains the agent can visit. Policy domain rules can block navigation entirely or pause the session for your approval.
