---
title: "MCP Quickstart: Claude Desktop & Cline"
description: "Add browser automation to Claude Desktop and Cline via MCP"
---

## What is MCP?

The Model Context Protocol (MCP) allows AI assistants like Claude Desktop and Cline to access external tools and services. By adding the Enigma MCP server, you give these assistants the ability to browse the web autonomously.
...
Close and reopen the application. You'll see Enigma tools available in the tool picker.
...
**You:** "Use Enigma to search for 'Claude AI features' on Google and tell me what you find."
