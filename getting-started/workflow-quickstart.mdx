---
title: "Workflow Quickstart: n8n, Make, Zapier"
description: "Integrate Enigma with no-code automation platforms"
---

## Understanding Enigma's Response Model

Before setting up your workflow, understand how Enigma returns results:
...
**Action:** Run Enigma task with form data
**Output:** Store result in database/sheet

**Example Use Case:** Lead enrichment — form captures company name, Enigma researches company details, result stored in CRM.
...
**Example Use Case:** Sales automation — new lead added to Salesforce, Enigma finds LinkedIn profile and company info, updates Salesforce.
