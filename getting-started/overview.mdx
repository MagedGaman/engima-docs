...
Alternatively, use [environments](/environments/overview) to persist login cookies across sessions — log in once and reuse the saved browser state for future tasks.
