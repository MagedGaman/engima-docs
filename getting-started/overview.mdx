...
Alternatively, use [browser profiles](/profiles/overview) to persist login cookies across sessions — log in once and reuse the saved browser state for future tasks.

[Guardrails documentation](/concepts/guardrails) | [Secrets documentation](/usage-guides/secrets) | [Profiles documentation](/profiles/overview)
