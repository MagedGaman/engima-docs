...
- **Description:** Maximum time a task can run before automatic termination. This is a task-level parameter, not a session-level setting. Note: Session inactivity timeout is fixed at 5 minutes.
