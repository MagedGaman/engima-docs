---
title: "Endpoints"
description: "Complete reference for all Enigma API endpoints"
icon: "route"
---
...
Poll for task result. No authentication required. No rate limit.
...
| `/start/active-sockets` | GET | Not required | None | Active connections |
